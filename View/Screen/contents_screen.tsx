    ...
    <View style={{marginBottom: 17}}>
      <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
        <BoldText
          ...
          backColorI={''} paddingVer={0} paddingHor={0}        />
        <SemiBoldText
          contentT={'See all'}
          fontSizeT={13}
